...
create table public.suppliers (
  ...
  city text not null,
  region text not null check (region in ('South Asia', 'Southeast Asia', 'East Asia', 'Europe', 'MENA')),
  category text not null check (category in ('apparel', 'beauty', 'home', 'food', 'accessories')),
